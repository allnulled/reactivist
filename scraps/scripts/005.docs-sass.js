...
//////////////////////////////////////
//////////////////////////////////////
browser.open("https://sass-lang.com/documentation/file.SASS_REFERENCE.html");
browser.onWeb(function(done) {
	const h1 = document.createElement("h1");
	h1.textContent = "Sass will give us the programmatic flexibility needed in the styling";
