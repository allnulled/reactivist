...
//////////////////////////////////////
//////////////////////////////////////
browser.open("https://docs.cypress.io/guides/getting-started/writing-your-first-test.html#Write-a-simple-test");
browser.onWeb(function(done) {
	const h1 = document.createElement("h1");
	h1.textContent = "Cypress is used in Reactivist as end-to-end testing framework";
