...
//////////////////////////////////////
//////////////////////////////////////
browser.open("https://www.gnu.org/software/gettext/manual/html_node/PO-Files.html");
browser.onWeb(function(done) {
	const h1 = document.createElement("h1");
	h1.innerHTML = `We will internationalize strings from PO files (for translators)`;
